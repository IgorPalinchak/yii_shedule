 ...
 */
class ShopsSearchFront extends Shops
{
    /**
     * {@inheritdoc}
     */
...
//            'sunday_close' => $this->sunday_close,
        ...
        $query->andFilterWhere(['<=', 'tuesday_open', $this->tuesday_open]);
        $query->andFilterWhere(['<=', 'wednesday_open', $this->wednesday_open]);
        $query->andFilterWhere(['<=', 'thursday_open', $this->thursday_open]);
        $query->andFilterWhere(['<=', 'friday_open', $this->friday_open]);
        $query->andFilterWhere(['<=', 'saturday_open', $this->saturday_open]);
        $query->andFilterWhere(['<=', 'sunday_open', $this->sunday_open]);





        $query->andFilterWhere(['>=', 'monday_close', $this->monday_open]);
        $query->andFilterWhere(['>=', 'tuesday_close', $this->tuesday_open]);
        $query->andFilterWhere(['>=', 'wednesday_close', $this->wednesday_open]);
        $query->andFilterWhere(['>=', 'thursday_close', $this->thursday_open]);
        $query->andFilterWhere(['>=', 'saturday_close', $this->friday_open]);
        $query->andFilterWhere(['>=', 'friday_close', $this->saturday_open]);
        $query->andFilterWhere(['>=', 'sunday_close', $this->sunday_open]);
